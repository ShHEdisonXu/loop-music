...
const defaultConfigs = [
  ...
  { configKey: 'system.download.brType', configValue: config.defaultBrType, configName: '默认下载音质', configType: 'select', configOption: 'standard,higher,exhigh,lossless,hires,jyeffect,sky,vivid,jymaster' },
